	...
	<div id="nav_list" class="scrollbar">
		<ul>
		   ...
		   <li <c:if test="${param.nav=='list_authority'}"> class="current"</c:if>><a
			...
			<li <c:if test="${param.nav=='list_etemplate'}"> class="current"</c:if>><a
					data-toggle="tooltip"
					href="<c:url value="/inner/emailTemplate/list"/>"
					data-placement="auto right" title="code"><span
					class="glyphicon glyphicon-modal-window" aria-hidden="true"></span>邮件模板</a></li>
			<li <c:if test="${param.nav=='list_account'}"> class="current"</c:if>><a
					data-toggle="tooltip"
					href="<c:url value="/inner/dailyAccount/list"/>"
					data-placement="auto right" title="code"><span
					class="glyphicon glyphicon-modal-window" aria-hidden="true"></span>日常账号</a></li>
